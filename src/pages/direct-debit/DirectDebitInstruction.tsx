...
export const DirectDebitInstruction: React.FC = () => {
    const params = useParams<Params>();
    const {t} = useTranslation();

    const {loading, data, error} = useQuery<GetDirectDebitInstructionQuery, GetDirectDebitInstructionQueryVariables>(gql(GetDirectDebitInstruction), {
        variables: {
            id: params.directDebitInstructionId
        }
    });
